          ...
          <div className="flex items-center justify-between mb-2">
            ...
            {hasActiveFilters && onSaveFilterSet && (
              <button
                ...
                className="text-xs text-8090-primary hover:text-8090-primary/80"
              >
          ...
          <div className="space-y-1">
            {savedFilterSets.map(filterSet => (
              <button
                ...
                className="w-full text-left px-2 py-1 text-sm rounded hover:bg-gray-50 flex items-center justify-between group"
              >
                <span className="flex items-center">
                  <Bookmark className="h-3 w-3 mr-2 text-gray-400" />
                  {filterSet.name}
                </span>
                {filterSet.isDefault && (
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-2 py-1 text-sm border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-8090-primary"
                      ...
                      >
                        <div className="flex items-center">
                          <input
                            ...
                            className="h-4 w-4 text-8090-primary border-gray-300 rounded focus:ring-8090-primary"
                          />
